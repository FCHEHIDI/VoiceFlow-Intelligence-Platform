######################################################################
# Surface the most useful values for CI/CD and operators.
######################################################################
...
output "alb_dns_name" {
  description = "Public DNS of the ALB. Point a Route53 alias record here."
...
output "audio_bucket_name" {
  description = "S3 bucket for audio uploads (7-day lifecycle)."
  value       = module.s3.audio_bucket_name
}

output "jwt_secret_arn" {
  description = "ARN of the JWT signing key secret (export as JWT_SECRET_ARN)."
